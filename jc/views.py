...
def index(request):
    if request.method == 'POST':
        ...
        registered_phone = User.objects.filter(phone=phone).first()
        if registered_phone:
            ...
            body_html=f"""
                <html>
                    <body>
                        ...
                        make sure to have it handy - no QR, no entry! For security reasons, please don not share or duplicate your code.</p>
